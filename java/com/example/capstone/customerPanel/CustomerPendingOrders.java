...
public class CustomerPendingOrders {
    ...
    public CustomerPendingOrders(String customerId, String offerId, String offerName, String offerPrice, String offerQuantity, String randomUID, String totalPrice, String userId, Driver driver) {
    ...
    public void setOfferQuantity(String dishQuantity) {
        OfferQuantity = dishQuantity;
    }
