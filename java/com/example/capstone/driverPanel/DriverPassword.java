...
public class DriverPassword extends AppCompatActivity {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                        ...
                                        user.updatePassword(ne).addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                if (task.isSuccessful()) {
                                                    ...
                                                    FirebaseDatabase.getInstance().getReference("Driver").child(userid).child("Password").setValue(ne);
                                                    FirebaseDatabase.getInstance().getReference("Driver").child(userid).child("ConfirmPassword").setValue(conf);

                                                    Toast.makeText(DriverPassword.this, "password updated", Toast.LENGTH_SHORT).show();
                                                } else {
                                                    Toast.makeText(DriverPassword.this, task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                                                }
                                            }
                                        });
                                    } else {
                ...
                forgot.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent aa=new Intent(DriverPassword.this,DriverForgotPassword.class);
                        startActivity(aa);
                    }
                });
